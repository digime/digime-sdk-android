package saas.test.app.features.readraw.view
...
import saas.test.app.MainActivity
import saas.test.app.R
import saas.test.app.databinding.FragmentReadRawBinding
...
class ReadRawFragment : Fragment(R.layout.fragment_read_raw) {
    ...
    private fun openFile(type: String, ext: String, content: ByteArray) {
        ...
        val uri: Uri = FileProvider.getUriForFile(
            requireContext(),
            "me.digi.examples.testapp.saasProvider",
            file
        )

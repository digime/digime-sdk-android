...
class AuthFragment : Fragment(R.layout.fragment_auth), View.OnClickListener {
    ...
    private fun setupClickListeners() {
        ...
        binding.facebook.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
        ...
        binding.instagram.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
        ...
        binding.twitter.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
        ...
        binding.fitbit.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
        ...
        binding.garming.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
        ...
        binding.googleFit.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
        ...
        binding.youtube.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
        ...
        binding.spotify.setOnCheckedChangeListener { buttonView, isChecked ->
            if(isChecked) {
                binding.twitter.isChecked =  false
                binding.instagram.isChecked =  false
                binding.facebook.isChecked =  false
